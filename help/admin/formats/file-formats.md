...
Dessa makron kan användas i alla formatfält. Se till exempel [Exempel på filformatsmakro](../formats/file-format-examples.md).
...
<table id="table_A3309E175ABF4651BD11CE3632B3C553"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ett alias för ett order-/mål-ID. </p> <p>Värdet för det här aliaset anges i <span class="wintitle"> ID för externt konto </span> fält för ett mål (i <span class="wintitle"> Grundinställningar </span> ). </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>En 10-siffrig UTC-, Unix-tidsstämpel. </p> <p>Den kan också formateras som <code>YYYYMMDDhhmmss</code> följa formateringsregler för Java-datum/tidsstämpel. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Makron används endast i rubrikfält. Se till exempel [Exempel på filformatsmakro](../formats/file-format-examples.md).
...
Makron används endast i datarader. Se till exempel [Exempel på filformatsmakro](../formats/file-format-examples.md).
...
<table id="table_E378F94A3907407AA8110C8EE6C10909"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="term"> Unik användaridentifierare för datapartner </span>. Returnerar det ID som du har tilldelat en användare/webbplatsbesökare om detta ID redan har synkroniserats med en <span class="keyword"> Audience Manager </span> enhets-ID. </p> <p>Om DPID är 0 returnerar makrot <span class="keyword"> Audience Manager </span> ID i stället för ditt ID för användaren. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Obligatoriskt när du använder villkoret <code>if</code> och <code>SEGMENT_LIST</code> och <code>REMOVED_SEGMENT_LIST</code> makron. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Partner-ID (PID). PID visas under <span class="wintitle"> Profil </span> i administratörsgränssnittet. </p> </td> 
  </tr> 
  <tr> 
